  ...
  return (
    <nav className="flex bg-black h-[12vh] items-center justify-between overflow-hidden">
      <div className="md:pl-10">
        ...
        <Link to="/">
          <h1 className="pl-5 md:pl-10 bg-gradient-to-r from-[#8A2387] via-[#E94057] to-[#F27121] text-transparent bg-clip-text font-poppins font-bold text-[26px]">
            CodeAlchemist
          </h1>
        </Link>
      </div>
